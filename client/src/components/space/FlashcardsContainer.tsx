  ...
  if (!flashcards || flashcards.length === 0) {
    return (
      <div className="flex-grow flex flex-col items-center justify-center text-center p-8">
        <p className="text-text/70 mb-4">No flashcards available for this Space.</p>
        <p className="text-sm text-text/50">Use the tools section to generate flashcards from your Space content.</p>
      </div>
    );
  }
